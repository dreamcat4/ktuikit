...
@implementation KTPopUpButton ( KTPopUpButtonIntegration )
...
- (void)ibPopulateAttributeInspectorClasses:(NSMutableArray *)classes {
	...
	// Replace "KTPopUpButtonIntegrationInspector" with the name of your inspector class.
