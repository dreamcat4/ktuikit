...
@implementation KTImageView ( KTImageViewIntegration )
...
- (void)ibPopulateAttributeInspectorClasses:(NSMutableArray *)classes {
	...
	// Replace "KTImageViewIntegrationInspector" with the name of your inspector class.
